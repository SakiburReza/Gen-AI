...
<template>
  <div class="relative flex flex-col items-center justify-center p-4">
    ...
    <!-- Text -->
    <fwb-badge
      :class="`flex items-center justify-between border rounded-md ${isClicked ? 'bg-blue-600 text-white border-blue-600' : 'bg-white text-gray-500 border-gray-300'} rounded-full px-4 py-2 cursor-pointer shadow-sm transition-all duration-200`"
      size="xl"

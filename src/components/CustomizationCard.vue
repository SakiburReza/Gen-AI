    ...
    <div class="p-5">
      ...
      <div class="mt-3 flex flex-nowrap gap-1 justify-start sm:flex-wrap xmd:flex xmd:flex-wrap xmd:gap-1">
        ...
        <button
          ...
          :class="[
      'py-2 px-6 sm:py-2 sm:px-8 xmd:px-10 rounded-xl font-semibold cursor-pointer flex items-center border group',
      selectedRatio === 'portrait_16_9'
        ? '!bg-tertiary !text-black-2 !border-tertiary'
        : 'bg-white text-black-2 border-gray-300 hover:bg-gray-100 hover:border-gray-400 group-active:bg-gray-200',
      ...
      selectedRatio === 'landscape_16_9'
        ? '!bg-tertiary !text-black-2 !border-tertiary'
        : 'bg-white text-black-2 group-active:bg-gray-200',
      isProcessing ? 'opacity-50 cursor-not-allowed' : ''
    ]"
          :disabled="isProcessing"
        >

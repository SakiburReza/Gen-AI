...
<template>
  <div v-if="videos.length === 0" class="flex flex-col justify-center items-center">
    <fwb-spinner size="12" />
  </div>
  <Splide
    v-else
  ...
  >
    ...
    >
      <video controls class="w-full rounded-lg shadow-lg cursor-pointer" :src="video.video"></video>

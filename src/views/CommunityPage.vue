...
<template>
  <div class="flex flex-col h-screen">
    ...
    <div class="flex flex-col md:flex-row flex-1">
      ...
      <!-- Sidebar Section -->
      <div class="md:w-64 md:ml-5 mt-5 md:mt-0 flex justify-center md:flex-none fixed top-9 right-9 w-60 h-full rounded-3xl overflow-hidden z-50 md:block" :class="{ 'hidden': !showMenu, 'block': showMenu }">

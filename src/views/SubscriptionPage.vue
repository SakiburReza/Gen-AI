...
<template>
  <div class="flex flex-col h-screen">
    ...
    <div
      class="bg-yellow-100 text-yellow-800 p-3 text-center font-medium px-4 sm:px-5 sm:my-3 xl:mx-40 lg:px-4 py-4 rounded">
      <span class="font-bold text-lg">★</span> Note: If you upgrade your account you will only be charged the difference
      between your current and the new package.
    </div>

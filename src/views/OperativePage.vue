...
<template>
  <div class="flex flex-col h-screen">
          ...
          >
            ...
            >
              ...
              <circle
                ...
                cy="7"
                r="6.5"
                :fill="isLikedState ? '#E12629' : '#808080'"
                stroke="white"
              />
            </svg>
          </button>
    ...
    <div class="flex flex-col md:flex-row flex-1">
      ...
      <div
        class="grid grid-cols-2 md:grid-cols-4 gap-4 w-full max-w-xs md:max-w-[75%] mx-auto ml-15 mb-5 mt-6 overflow-y-auto pr-2"
      ...
      <div class="w-full sm:w-[30%] p-6 flex-shrink-0">
        ...
        >
          ...
          <div class="w-full space-y-6">
            ...
            <div class="max-w-md mx-auto sm:max-w-lg md:max-w-2xl bg-white rounded-lg shadow-2xl">
              <ImageInputCard
                title="Insert Your Face Image"
                @input="(file) => (faceImage = file)"
                :resetKey="resetKey"
              />
            </div>
          </div>
        ...
        <div
          v-if="activeFunctionality === 'Templates (Beta)'"
          class="bg-white p-6 space-y-6 flex-shrink-0"
        >
          <!-- Video Carousel -->
          <VideoCarousel
            @video-selected="(object) => (selectedVideo = object)"
            :resetKey="resetKey"
          />

    ...
    <div class="flex flex-row-reverse h-screen">
      ...
      <div class="float-right flex">
        ...
        <div @click="toggleSidebar" v-if="!isSidebarOpen"
             class="sm:fixed sm:top-10 sm:right-5 md:right-10 w-15 sm:p-6 flex-shrink min-h-screen bg-tertiary shadow-lg 
        ...
        <div class="hidden sm:block sm:w-52 md:w-65 lg:w-80 xl:w-96 h-screen shadow-lg"
